          ...
          <div
            ...
            <div class="content-area">
              ...
              <div class="form-group">
                ...
                <textarea
                  id="bio"
                  placeholder="I own a computer..."></textarea>
                <p>
                  ...
                  <div class="section">
                    <div class="toggle">
                      <div class="d-flex flex-column w-75">
                        ...
                        <span>Receive emails about your account activity.</span>
                      </div>
                      <label class="switch">
                        <input type="checkbox" />
                    ...
                    <div class="toggle">
                      <div class="d-flex flex-column w-75">
                        ...
                        <span>Receive emails about new products, features, and
                          more.</span>
                      </div>
                    ...
                    <div class="toggle">
                      <div class="d-flex flex-column w-75">
                        <h4>Social emails</h4>
                        <span>Receive emails for friend requests, follows, and
                          more.</span>
                      </div>
                    ...
                    <div class="toggle">
                      <div class="d-flex flex-column w-75">
                        ...
                        <span>Receive emails about your account activity and
                          security.</span>
                      </div>
                ...
                <div class="radio-checkbox">
                  <div class="option">
                    <input
                      ...
                      name="notification"
                      checked />
                    <label for="check">Use different settings for my mobile devices<br />
                      <span class="sub-text">
                        ...
                        <div class="user-item">
                          ...
                          <button
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li>
                                <a class="dropdown-item" href="#">Remove Access</a>
                              </li>
                            </ul>
                          </button>
                        </div>
