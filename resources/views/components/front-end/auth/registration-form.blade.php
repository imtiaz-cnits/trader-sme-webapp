...
<div class="auth-container">
  ...
  <div class="right-panel">
    ...
    <div class="wrap w-100" style="height: 100vh; padding-top: 20px;">

      <div class="box d-flex justify-content-end gap-2 align-items-center mb-4">
        <p class="tag m-0" id="dynamic-title" style="font-size: 14px;">
      ...
      <!-- Register Form Start -->
      <div class="form-wrapper {{ $form === 'register' ? 'active' : '' }}" id="register-form">
        <div class="wrap lg:mt-5">
          <div class="content">
            <h5 class="title">Welcome to Trader SME!</h5>
            <p class="desc">Create your account below.</p>
            <button class="social-btn w-100 mb-2"><img src="{{asset('back-end/assets/icon/Google.png')}}" alt="" /> Sign up with Google</button>
            <button class="social-btn w-100"><img src="{{asset('back-end/assets/icon/Facebook.png')}}" alt="" /> Sign up with Facebook</button>
            <div class="bar">
              <div class="line"></div><span class="or">or</span>
              <div class="line"></div>
            </div>
            ...
            <form id="registerForm">
              ...
              <div class="form-grp">
                <label>Email</label>
                <input type="email" id="register-email" name="email" class="form-control" placeholder="Email. . ." required />
              </div>
              <div class="password-wrapper">
                <label class="form-label">Password</label>
                <input type="password" id="register-password" name="password" class="form-control password-input" placeholder="Your password. . ." required />
                <i class="fa-solid fa-eye toggle-password"></i>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="checkbox" id="termsCheck" required />
                <label class="form-check-label" for="termsCheck">I agree to the <span>Terms</span> & <span>Conditions</span></label>
              </div>
              <button type="submit" class="register-btn w-100">Register</button>
              <div class="account-msg">Already have an account? <button type="button" onclick="showForm('login')" class="btn btn-link">Login</button></div>
            </form>
          </div>
        </div>
      </div>
      ...
      <!-- Login Form Start -->
      <div class="form-wrapper {{ $form === 'login' ? 'active' : '' }}" id="login-form">
        <div class="wrap lg:mt-5">
          <div class="content">
            ...
            <form id="loginForm">
              <div class="form-grp">
                ...
                <input type="text" id="email" class="form-control" placeholder="Your username/email. . ." required />
              </div>
              <div class="password-wrapper">
                <label class="form-label">Password</label>
                <input type="password" id="password" class="form-control password-input mb-0" placeholder="Your password. . ." required />
                <i class="fa-solid fa-eye toggle-password"></i>
              </div>
              <div class="forgot-box d-flex align-items-center justify-content-between mb-3 mt-2">
                <div>
                  <input type="checkbox" id="remember"> <label for="remember" style="font-size: 14px; color: var(--text2); cursor:pointer;">Remember me</label>
                </div>
                <a href="/forgot-password" class="forgot-pass">Forgot Password</a>
              </div>
              <button type="submit" class="login-btn w-100">Login</button>
              <div class="account-msg">Don’t have an account? <button type="button" onclick="showForm('register')" class="btn btn-link">Register</button></div>
            </form>
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    // 1. Form Switching Logic (With Dynamic Title)
    function showForm(type) {
      ...
      const animateIn = (element) => {
        ...
        setTimeout(() => {
          element.classList.remove("form-wrapper-fade-in");
        }, 500);
      };
      ...
      if (type === "register") {
        ...
        dynamicTitle.innerText = "Already have an account?";
      } else {
        registerForm.classList.remove("active");
        animateIn(loginForm);
        dynamicTitle.innerText = "Create an Account";
      }
    }
    ...
    // 4. Registration Submission (Axios)
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      document.getElementById('registerForm')?.addEventListener('submit', onRegistration);
