...
<div class="auth-container">
  ...
  <div class="right-panel">
    <!-- Register Form -->
    {{-- <div class="form-wrapper active" id="register-form" onsubmit="event.preventDefault(); onRegistration();">
          <div class="box d-flex justify-content-end gap-2 align-items-center">
            <p class="tag">Login</p>
            <span>|</span>
            <!-- Language Toggle -->
          ...
          <div class="wrap mt-3">
            <div class="content">
              <h5 class="title">Welcome to Trader SME!</h5>
              <p class="desc">Create your account below.</p>
              <button class="social-btn w-100 mb-2">
                <img src="{{asset('back-end/assets/icon/Google.png')}}" alt="" />
    Sign up with Google
    </button>
    <button class="social-btn w-100">
      <img src="{{asset('back-end/assets/icon/Facebook.png')}}" alt="" />
    ...
    <form>
      ...
      <div class="form-check">
        ...
        <label class="form-check-label" for="termsCheck">
          I agree to the <span>Terms</span> & <span>Conditions</span>
        </label>
      </div>
...
<div class="form-wrapper active" id="register-form">
  <div class="wrap mt-3">
    <div class="content">
      <h5 class="title">Welcome to Trader SME!</h5>
      <p class="desc">Create your account below.</p>
      ...
      <!-- Inner form just for submit event -->
      <form id="registerForm" onsubmit="onRegistration(event)">
        <div class="row g-2">
          <div class="col-6 mt-0">
            <div class="form-grp">
        ...
        <button type="submit" class="register-btn w-100">Register</button>

        <div class="account-msg">
          Already have an account?
          <button type="button" onclick="showForm('login')" class="btn btn-link">
            Login
          </button>
        </div>
      </form>
...
<div class="form-wrapper" id="login-form">
  <div class="box d-flex justify-content-end gap-2 align-items-center">
    <p class="tag">Create an Account</p>
    <span>|</span>
    <!-- Language Toggle -->
    <div class="language-selector">
      <div class="selected-language">
      ...
      <form id="loginForm" onsubmit="onLogin(event)">
        ...
        <div class="password-wrapper">
          ...
          <input
            ...
            id="password"
            name="password"
            class="form-control password-input mb-0"
            placeholder="Your password. . ." />
          <i class="fa-solid fa-eye toggle-password"></i>
        </div>

        <div class="forgot-box d-flex align-items-center justify-content-between mb-3">
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    async function onRegistration(event) {
      ...
      if (!nameEl || !usernameEl || !emailEl || !passwordEl) {
      ...
      try {
        let response = await axios.post("/api/user-registration", formData, {
          headers: {
    ...
    if (registerForm) {
      registerForm.addEventListener('submit', onRegistration);
    }
  });
  ...
  document.addEventListener("DOMContentLoaded", function() {
    async function onLogin(event) {
      ...
      try {
        let response = await axios.post("/login-page", {
          email: email,
          password: password
        }, {
          headers: {
