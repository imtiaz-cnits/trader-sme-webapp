...
//     // We use a broader selector to ensure we catch both desktop and mobile buttons
...
//             // Remove previous listeners to avoid duplicates if script runs twice
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const selectedEntriesText = document.getElementById(
        "selected-entries-text",
    );
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document
        .querySelectorAll(".collapse-content")
    ...
    datasets: [
        {
            label: "",
            data: [
                1, 1.2, 1.8, 1.8, 2.5, 3, 2.2, 3.4, 3.3, 4.2, 3.4, 4.8, 5.1,
                5.5, 5.3, 5.2, 6.1, 6.7, 7.3, 6.8, 7.5, 8.5, 7.8, 8.1, 7.9,
            ],
            ...
            datasets: [
                {
                    label: "Optimized",
                    data: [
                        700, 600, 400, 550, 1100, 800, 600, 850, 400, 800, 650,
                        1150,
                    ],
                ...
                },
                {
                    label: "Current",
                    data: [
                        600, 500, 350, 450, 950, 700, 500, 750, 350, 700, 550,
                        1000,
                    ],
                    backgroundColor: (context) => {
                        const chart = context.chart;
